                                                    ...
                                                    <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab2" id="bootstrap-wizard-validation-tab2">
                                                        <form id="fmr_clientes2" class="fmr_clientes needs-validation" novalidate="novalidate" data-wizard-form="2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <label class="form-label" for="bootstrap-wizard-validation-wizard-fing">Fecha de Ingreso</label>
                                                                    <input class="form-control" id="bootstrap-wizard-validation-wizard-fing" name="fing" type="date" required />
                                                                    <div class="valid-feedback">¡Ok!</div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <label for="">Forma de pago</label>
                                                                    <div class="form-group col-md-12 mb-2">
                                                                        <select class="form-select selectpicker" id="fpago" size="1" name="fpago" required>
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-3">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="form-group col-md-12 mb-2">
                                                                        <select class="form-control" id="riva" size="1" name="riva" required>
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="form-group col-md-12 mb-2">
                                                                        <select class="form-control" id="rfte" size="1" name="rfte" required>
                                                                            <option value="0">No</option>
                                                                            <option value="1">Si</option>
                                                                        </select>
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="form-group col-md-12 mb-2">
                                                                        <select class="form-select selectpicker" id="rica" size="1" name="rica" required>
                                                                            <option value="0">No</option>
                                                                            <option value="1">Si</option>
                                                                        </select>
                                                                    </div>
                                            ...
                                            <div class="card-body py-4" id="wizard-controller">
                                                <div class="tab-content">
                                                    ...
                                                    <div class="tab-pane px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab2-mod" id="bootstrap-wizard-validation-tab2-mod">
                                                        <form id="fmr_clientes2_mod" class="fmr_clientes_mod needs-validation" novalidate="novalidate" data-wizard-form="2">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <label class="form-label" for="bootstrap-wizard-validation-wizard-fing">Fecha de Ingreso</label>
                                                                    <input class="form-control" id="bootstrap-wizard-validation-wizard-fing" name="fing_mod" type="date" required />
                                                                    <div class="valid-feedback">¡Ok!</div>
                                                                </div>
                                                                <div class="col-md-4">
                                                    ...
                                                    <div class="tab-pane text-center px-sm-3 px-md-5" role="tabpanel" aria-labelledby="bootstrap-wizard-validation-tab4-mod" id="bootstrap-wizard-validation-tab4-mod">
                                                        ...
                                                        <p id="resp_mensaje_mod">{resp_mensaje}</p><a class="btn btn-primary px-5 my-3" href="#" onclick="cerrar_modal()">Cerrar</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer mt-4 bg-body-tertiary">
