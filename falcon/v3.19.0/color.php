...
<head>
    ...
    <!-- ===============================================--><!--    Document Title--><!-- ===============================================-->
    <title>Visual Ciem | Colores</title>
                                ...
                                <div id="tableExample3" data-list='{"valueNames":["codigo","descripcion"],"page":5,"pagination":true}'>
                                    <div class="row justify-content-end g-0">
                                        <div class="col-auto col-sm-7 mb-3">
                                            <button class="btn btn-outline-primary btn-sm me-1 mb-1" type="button" data-bs-toggle="modal" data-bs-target="#guardarModal">Registrar color</button>
                                        </div>
                        ...
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                <div class="rounded-top-3 bg-body-tertiary py-3 ps-4 pe-6">
                                    <h4 class="mb-1" id="staticBackdropLabel">Registro de colores</h4>
                                ...
                                <div class="p-4">
                                    <div class="row">
                                        <form id="fmr_colores" method="POST" class="fmr_colores row g-2 needs-validation" novalidate="">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="color">Descripción</label>
                                                <input class="form-control" id="descripcion" name="descripcion" type="text" required />
                                                <div class="valid-feedback">¡Ok!</div>
                                            </div>
                                            <div class="modal-footer">
                                                <div class="col-12 d-grid  gap-0">
                                                    <button class="btn btn-outline-primary me-1 mb-1" type="submit">Agregar color</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                ...
                <div class="modal fade" id="editarModal" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg mt-6" role="document">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                <div class="rounded-top-3 bg-body-tertiary py-3 ps-4 pe-6">
                                    <h4 class="mb-1" id="staticBackdropLabel">Editar color</h4>
                                    <!-- <p class="fs-11 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> -->
                                </div>
                                <div class="p-4">
                                    <div class="row">
                                        <form id="fmr_colores_editar" method="POST" class="fmr_colores_editar row g-2 needs-validation" novalidate="">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="descripcion_mod">Descripción</label>
                                                <input class="form-control" id="descripcion_mod" name="descripcion_mod" type="text" required />
                                                <div class="valid-feedback">¡Ok!</div>
                                            </div>
                                            <div class="modal-footer">
                                                <div class="col-12 d-grid  gap-0">
