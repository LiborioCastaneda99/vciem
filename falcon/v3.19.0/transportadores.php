...
$permisoRequerido = "ver_transportadores";
...
<head>
    ...
    <!-- ===============================================--><!--    Document Title--><!-- ===============================================-->
    <title>Visual Ciem | Transportadores</title>
...
<body>
                ...
                <div class="card mb-3">
                    <div class="card-header bg-body-tertiary">
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="mb-0">Transportadores</h6>
                            </div>
                        </div>
                    </div>
                                ...
                                <div id="tableExample3" data-list='{"valueNames":["codigo","nombre"],"page":5,"pagination":true}'>
                                    <div class="row justify-content-end g-0">
                                        <div class="col-auto col-sm-7 mb-3">
                                            <button class="btn btn-outline-primary btn-sm me-1 mb-1" type="button" data-bs-toggle="modal" data-bs-target="#guardarModal">Registrar transportador</button>
                                        </div>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped fs-10 mb-0 ">
                                            ...
                                            <thead class="bg-200">
                                                <tr>
                                                    ...
                                                    <th class="text-900 sort" data-sort="conduc">Conductor</th>
                        ...
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                <div class="rounded-top-3 bg-body-tertiary py-3 ps-4 pe-6">
                                    <h4 class="mb-1" id="staticBackdropLabel">Registro de transportadores</h4>
                                    <!-- <p class="fs-11 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> -->
                                </div>
                                <div class="p-4">
                                    <div class="row">
                                        <form id="fmr_transportadores" method="POST" class="fmr_transportadores row g-2 needs-validation" novalidate="">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="conduc">Conductor</label>
                                                <input class="form-control" id="conduc" name="conduc" type="text" required />
                                                <div class="valid-feedback">¡Ok!</div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="modal-footer">
                                                <div class="col-12 d-grid  gap-0">
                                                    <button class="btn btn-outline-primary me-1 mb-1" type="submit">Agregar transportador</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                ...
                <div class="modal fade" id="editarModal" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg mt-6" role="document">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                <div class="rounded-top-3 bg-body-tertiary py-3 ps-4 pe-6">
                                    <h4 class="mb-1" id="staticBackdropLabel">Editar transportador</h4>
                                    <!-- <p class="fs-11 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> -->
                                </div>
                                <div class="p-4">
                                    <div class="row">
                                        <form id="fmr_transportadores_editar" method="POST" class="fmr_transportadores_editar row g-2 needs-validation" novalidate="">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <label class="form-label" for="conduc_mod">Conductor</label>
                                                <input class="form-control" id="conduc_mod" name="conduc_mod" type="text" required />
                                                <div class="valid-feedback">¡Ok!</div>
                                            </div>
                                            <div class="col-md-6">
    ...
    <script src="js/transportadores.js"></script>
</body>
