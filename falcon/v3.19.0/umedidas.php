...
<body>
                                ...
                                <div id="tableExample3" data-list='{"valueNames":["codigo","nombre"],"page":5,"pagination":true}'>
                                    <div class="row justify-content-end g-0">
                                        <div class="col-auto col-sm-7 mb-3">
                                            <button class="btn btn-outline-primary btn-sm me-1 mb-1" type="button" data-bs-toggle="modal" data-bs-target="#guardarModal">Registrar umedida</button>
                                        </div>
                                        ...
                                        <form id="fmr_umedidas" method="POST" class="fmr_umedidas row g-2 needs-validation" novalidate="">
                                            ...
                                            <div class="modal-footer">
                                                <div class="col-12 d-grid  gap-0">
                                                    <button class="btn btn-outline-primary me-1 mb-1" type="submit">Agregar umedida</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
    ...
    <script src="js/umedidas.js"></script>
</body>
