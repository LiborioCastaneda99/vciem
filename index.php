...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body py-2">
                                <div class="d-flex align-items-center position-relative mb-3">
                                    ...
                                    <div class="flex-1 ms-3">
                                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.html.htm">Emma Watson</a></h6>
                                ...
                                <div class="d-flex align-items-center position-relative mb-3">
                                    ...
                                    <div class="flex-1 ms-3">
                                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.html.htm">Antony Hopkins</a></h6>
                                ...
                                <div class="d-flex align-items-center position-relative mb-3">
                                    ...
                                    <div class="flex-1 ms-3">
                                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.html.htm">Anna Karinina</a></h6>
                                ...
                                <div class="d-flex align-items-center position-relative mb-3">
                                    ...
                                    <div class="flex-1 ms-3">
                                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.html.htm">John Lee</a></h6>
                                        <p class="text-500 fs-11 mb-0">Admin</p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center position-relative false">
                                    ...
                                    <div class="flex-1 ms-3">
                                        <h6 class="mb-0 fw-semi-bold"><a class="stretched-link text-900" href="pages/user/profile.html.htm">Rowen Atkinson</a></h6>
                                        <p class="text-500 fs-11 mb-0">Editor</p>
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer bg-body-tertiary p-0"><a class="btn btn-sm btn-link d-block w-100 py-2" href="app/social/followers.html.htm">All active users<span class="fas fa-chevron-right ms-1 fs-11"></span></a></div>
                        </div>
                    </div>
    ...
    <div class="offcanvas offcanvas-end settings-panel border-0" id="settings-offcanvas" tabindex="-1" aria-labelledby="settings-offcanvas">
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2" src="assets/img/icons/left-arrow-from-left.svg" width="20" alt="">
                    <div class="flex-1">
                        ...
                        <p class="fs-10 mb-0">Switch your language direction </p><a class="fs-10" href="documentation/customization/configuration.html.htm">RTL Documentation</a>
                    </div>
                </div>
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2" src="assets/img/icons/arrows-h.svg" width="20" alt="">
                    <div class="flex-1">
                        ...
                        <p class="fs-10 mb-0">Toggle container layout system </p><a class="fs-10" href="documentation/customization/configuration.html.htm">Fluid Documentation</a>
                    </div>
                </div>
            ...
            <p> <a class="fs-10" href="modules/components/navs-and-tabs/vertical-navbar.html.htm#navbar-styles">See Documentation</a></p>
            <div class="btn-group d-block w-100 btn-group-navbar-style">
                <div class="row gx-2">
