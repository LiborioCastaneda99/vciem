    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.length > 0) {
                ...
                var options = {
                    valueNames: ['codigo', 'nombre', 'zona', 'subzona', 'ciudad'],
                    item: '<tr><td class="codigo"></td><td class="nombre"><td class="zona"></td></td><td class="subzona"></td><td class="ciudad"></td>'
                };
                ...
                var searchList = new List('myTable', {
                    valueNames: ['codigo', 'nombre', 'subzona', 'zona', 'ciudad'],
                    page: 5
                });
                ...
                $('#myTable tbody').html('<tr><td colspan="5" class="text-center">No hay clientes disponibles</td></tr>');
            }
        },
        error: function() {
