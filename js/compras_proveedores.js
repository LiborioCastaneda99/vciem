...
$('#btnConsultarFactEsp').click(function () {
    // $('#buscarProductos').modal('show');
    var proveedor_id = parseFloat($('#lstProveedoresFactEsp').val());
    ...
    $.ajax({
        type: 'POST',
        url: urlprocess,
        data: 'proveedor=' + proveedor_id + '&proceso=consultar_factura_espera',
        dataType: 'json',
        success: function (response) {
            if (response.status == 'success') {
                ...
                cargar_proveedores(ventas.proveedor, 'lstProveedoresFact', '');
                cargar_bodega(ventas.bodega, 'lstBodegaFact', '');
                cargar_vendedores(ventas.vendedor, 'lstVendedoresFact', '');
                cargar_oficinas('', 'lstSucursalFact', '');
...
// Funcion para cargar las listas select con opcion de busqued
