...
// $html = '<h1 style="margin-top:100px;">Hello, world!</h1>';
...
// Agregar el texto
// Contenido HTML
// Establecer las coordenadas X e Y iniciales
// $posX = 10;
// $posY = -145;
...
// Definir el tamaño de la página como carta (8.5 x 11 pulgadas)
$dompdf->setPaper('letter');

// Establecer los márgenes (por ejemplo, 1 pulgada en todos los lados)
// $dompdf->setOptions(['margin-top' => 1, 'margin-bottom' => 1, 'margin-left' => 1, 'margin-right' => 1]);
...
<style>
        body {
            font-family: courier;
            font-size: 9px;
            margin-bottom: 150px; /* Ajusta esta distancia según sea necesario */
        }
        .footer {
            position: fixed;
            left: 0;
            ...
            bottom: 300px; /* Ajusta esta distancia según sea necesario */
        }        
    </style>';

// Aumentar la posición Y para la siguiente sección
// $posY += 50;
...
$html .= '
    ...
    <div>
        <img style="" src="https://via.placeholder.com/200" alt="Logo de la empresa">
...
$html .= '
        <table style="border-radius: 7px; border: 1px solid #000; width:100%; text-align:left; margin-top: 10px;">
            <tr>
...
$html .= '
    <table style=" width:100%;">
        <tr>
            <td rowspan="7">
                <img style="" src="<?= $qrFilename;?>" alt="Logo del qr">
            </td>
...
// Enviar el PDF al navegador para que se muestre en línea
