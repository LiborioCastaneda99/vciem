...
$html = $style . '
<h1 style="text-align: center;">Reporte de ciudades</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, resum FROM tbciudades WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de ciudades - Visual Ciem');
...
$pdf->Output('reporte_ciudades.pdf', 'I');
