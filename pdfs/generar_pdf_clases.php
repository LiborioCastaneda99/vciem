...
$html = $style . '
<h1 style="text-align: center;">Reporte de clases</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, resum FROM tbclases WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de clases - Visual Ciem');
...
$pdf->Output('reporte_clases.pdf', 'I');
