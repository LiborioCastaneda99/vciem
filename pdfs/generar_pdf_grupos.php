...
$html = $style . '
<h1 style="text-align: center;">Reporte de grupos</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, resum, clase, dias FROM tbgrupos WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de grupos - Visual Ciem');
