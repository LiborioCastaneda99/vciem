...
$html = $style . '
<h1 style="text-align: center;">Reporte de nombods</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, `dir`, `tel`, `nit` FROM tbnombod WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de nombods - Visual Ciem');
...
$pdf->Output('reporte_nombods.pdf', 'I');
