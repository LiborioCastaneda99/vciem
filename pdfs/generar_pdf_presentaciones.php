...
$html = $style . '
<h1 style="text-align: center;">Reporte de presentaciones</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre` FROM presentaciones WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de presentaciones - Visual Ciem');
...
$pdf->Output('reporte_presentaciones.pdf', 'I');
