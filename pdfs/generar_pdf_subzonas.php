...
$html = $style . '
<h1 style="text-align: center;">Reporte de subzonas</h1>
...
<table style="width: 100%; border-collapse: collapse;">
    <tr>
        ...
        <th style="width: 30%;">Resum</th>
    </tr>
';

// Realizar una consulta a la base de datos (asegúrate de tener una conexión establecida)
$sql = "SELECT SZ.id, SZ.codigo, Z.nombre As zona, SZ.nombre, SZ.resum, SZ.activo, SZ.created_at FROM `tbsubzonas` AS SZ
...
$html .= '</table>';
$pdf->setTitle('Reporte de subzonas - Visual Ciem');
...
$pdf->Output('reporte_subzonas.pdf', 'I');
