...
$html = $style . '
<h1 style="text-align: center;">Reporte de tallas</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre` FROM tbtallas WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de tallas - Visual Ciem');
...
$pdf->Output('reporte_tallas.pdf', 'I');
