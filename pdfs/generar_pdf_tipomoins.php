...
$html = $style . '
<h1 style="text-align: center;">Reporte de tipomoin</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, resum FROM tbtipomoin WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de tipomoin - Visual Ciem');
...
$pdf->Output('reporte_tipomoin.pdf', 'I');
