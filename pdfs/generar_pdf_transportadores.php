...
$html = $style . '
<h1 style="text-align: center;">Reporte de transportadores</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, resum, conduc, est FROM tbtransportadores WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de transportadores - Visual Ciem');
...
$pdf->Output('reporte_transportadores.pdf', 'I');
