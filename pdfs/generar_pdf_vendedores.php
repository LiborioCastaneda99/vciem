...
$html = $style . '
<h1 style="text-align: center;">Reporte de vendedores</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, resum, est FROM tbvendedores WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de vendedores - Visual Ciem');
...
$pdf->Output('reporte_vendedores.pdf', 'I');
