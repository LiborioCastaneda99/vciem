...
$html = $style . '
<h1 style="text-align: center;">Reporte de zonas</h1>
...
$sql = "SELECT `id`, `codigo`, `nombre`, resum FROM tbzonas WHERE activo = 1;";
...
$html .= '</table>';
$pdf->setTitle('Reporte de zonas - Visual Ciem');
...
$pdf->Output('reporte_zonas.pdf', 'I');
