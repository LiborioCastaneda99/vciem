...
<head>
    ...
    <!-- ===============================================--><!--    Document Title--><!-- ===============================================-->
    <title>Visual Ciem | Usuarios</title>
                                    ...
                                    <div class="row justify-content-end g-0">
                                        ...
                                        <div class="d-flex align-items-center" id="table-contact-replace-element">
                                            <button class="btn btn-falcon-default btn-sm" type="button" id="btnAgregar" data-bs-toggle="modal" data-bs-target="#guardarModal">
                                                ...
                                                <span class="d-none d-sm-inline-block d-xl-none d-xxl-inline-block ms-1" title="Registrar usuario">Agregar</span>
                                            </button>
                                        ...
                                        <table id="myTable" class="table table-bordered table-striped fs-10 mb-0 ">
                                            ...
                                            <thead class="bg-200">
                                                <tr>
                                                    ...
                                                    <th class="text-900 sort" data-sort="correo_electronico">Correo electronico</th>
                        ...
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                <div class="rounded-top-3 bg-body-tertiary py-3 ps-4 pe-6">
                                    <h4 class="mb-1" id="staticBackdropLabel">Registro de usuarios</h4>
                                    <!-- <p class="fs-11 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> -->
                                </div>
                                <div class="p-4">
                                    <div class="row">
                                        <form id="fmr_usuarios" method="POST" class="fmr_usuarios row g-2 needs-validation" novalidate>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="correo_electronico" name="correo_electronico" type="text" required="" />
                                                <div class="valid-feedback">¡Ok!</div>
                                            </div>
                                            <div class="col-md-12">
                                                <label>Rol <span class="text-danger"> * </span></label>
                                                <div class="input-group col-md-12 mb-2">
                                                    <select class="form-select" id="lstRolesAgregar" name="lstRolesAgregar">
                                                    </select>
                                            ...
                                            <div class="modal-footer">
                                                <div class="col-12 d-grid  gap-0">
                                                    <button class="btn btn-outline-primary me-1 mb-1" type="submit">Agregar usuario</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                ...
                <div class="modal fade" id="editarModal" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg mt-6" role="document">
                        <div class="modal-content border-0">
                            ...
                            <div class="modal-body p-0">
                                <div class="rounded-top-3 bg-body-tertiary py-3 ps-4 pe-6">
                                    <h4 class="mb-1" id="staticBackdropLabel">Editar usuario</h4>
                                    <!-- <p class="fs-11 mb-0">Added by <a class="link-600 fw-semi-bold" href="#!">Antony</a></p> -->
                                </div>
                                <div class="p-4">
                                    <div class="row">
                                        <form id="fmr_usuarios_editar" method="POST" class="fmr_usuarios_editar row g-2 needs-validation" novalidate="">
                                            <div class="col-md-2">
                                                <label class="form-label" for="codigo">Codigo</label>
                                                <input class="form-control" id="id" name="id" type="hidden" />
                                                <input class="form-control" id="codigo_mod" name="codigo_mod" type="text" required disabled />
                                                <div class="valid-feedback">¡Ok!</div>
                                            </div>
                                            <div class="col-md-5">
                                            ...
                                            <div class="col-md-5">
                                                <label class="form-label" for="correo_electronico_mod">Correo electronico</label>
                                                <input class="form-control" id="correo_electronico_mod" name="correo_electronico_mod" type="text" required />
                                                <div class="valid-feedback">¡Ok!</div>
                                            </div>
                                            <div class="col-md-12">
                                                <label>Rol <span class="text-danger"> * </span></label>
                                                <div class="input-group col-md-12 mb-2">
                                                    <select class="form-select" id="lstRolesMod" name="lstRolesMod">
                                                    </select>
